<div class="form-group {{ $errors->has('facebook_title') ? 'has-error' : '' }}">
	...
	<input type="text" id="facebook_title" name="facebook_title" placeholder="Facebook Title" class="form-control" value="{{ old('facebook_title') ?? $field->getModel()->seo->facebook_title ?? null }}">
...
<div class="form-group {{ $errors->has('facebook_description') ? 'has-error' : '' }}">
    ...
    <textarea id="facebook_description" name="facebook_description" placeholder="Facebook Description" class="form-control">{{ old('facebook_description') ?? $field->getModel()->seo->facebook_description ?? null }}</textarea>
